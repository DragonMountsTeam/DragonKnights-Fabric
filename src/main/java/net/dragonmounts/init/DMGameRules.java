...
public class DMGameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanValue> IS_EGG_PUSHABLE = register("dragonmounts.isEggPushable", GameRules.Category.MISC, createBooleanRule(false));
    public static final GameRules.Key<GameRules.BooleanValue> IS_EGG_OVERRIDDEN = register("dragonmounts.isEggOverridden", GameRules.Category.MISC, createBooleanRule(true));
